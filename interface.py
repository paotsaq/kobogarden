...
class SingleHighlightWidget(Widget, can_focus=True):
    ...
    def __init__(self, highlight: Option, soup: str, start: int, end: int, classes) -> None:
        super().__init__()
...
class SingleHighlightsScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        highlight_widget = SingleHighlightWidget(self.highlight, soup, start, end,
                                    classes="border90").focus()

        yield highlight_widget       
        yield Input(classes='highlight_input',
